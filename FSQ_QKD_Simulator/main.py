...
print("Public test indices:", random_select)
print("Alice's public test bits:", alice_test_bits)
print("Bob's public test bits:", bob_test_bits)
print("Alice's remaining key:", alice_remaining_key)
print("Bob's remaining key:", bob_remaining_key)
